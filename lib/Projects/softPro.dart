...
class Softwareproject extends StatefulWidget {
  // final Project project;
//final List<Project> project =[];
  // Softwareproject(this.project);
  @override
  _SoftwareprojectState createState() => _SoftwareprojectState();
}
 
class _SoftwareprojectState extends State<Softwareproject> {
 //final String url = "http://192.168.1.100:3000/users/project/viewProject";
  final String url = "http://192.168.1.8:3000/users/dev_home/softProject";
  int a=0;
