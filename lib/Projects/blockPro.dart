...
class Blockproject extends StatefulWidget {
  // final Project project;
//final List<Project> project =[];
  // Blockproject(this.project);
  @override
  _BlockprojectState createState() => _BlockprojectState();
}
 
class _BlockprojectState extends State<Blockproject> {
 //final String url = "http://192.168.1.100:3000/users/project/viewProject";
  final String url = "http://192.168.1.8:3000/users/dev_home/blockchain";
  int a=0;
