...
import 'SelectedProjects/web.dart';

class Machineproject extends StatefulWidget {
  // final Project project;
//final List<Project> project =[];
  // Machineproject(this.project);
  @override
  _MachineprojectState createState() => _MachineprojectState();
}
 
class _MachineprojectState extends State<Machineproject> {
 //final String url = "http://192.168.1.100:3000/users/project/viewProject";
  final String url = "http://192.168.1.8:3000/users/dev_home/machlearn";
  int a=0;
                                ...
                                child: Center(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      new Text(
snapshot.data[id].payment.isEmpty?'Bid project' :snapshot.data[id].payment+" \$",                                        style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            color: Colors.blue,
                                            fontSize: 17),
                                      ),
