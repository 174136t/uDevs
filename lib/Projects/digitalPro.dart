...
class Digitalproject extends StatefulWidget {
  // final Project project;
//final List<Project> project =[];
  // Digitalproject(this.project);
  @override
  _DigitalprojectState createState() => _DigitalprojectState();
}
 
class _DigitalprojectState extends State<Digitalproject> {
 //final String url = "http://192.168.1.100:3000/users/project/viewProject";
  final String url = "http://192.168.1.8:3000/users/dev_home/digimark";
  int a=0;
