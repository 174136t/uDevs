...
class Multyproject extends StatefulWidget {
  // final Project project;
//final List<Project> project =[];
  // Multyproject(this.project);
  @override
  _MultyprojectState createState() => _MultyprojectState();
}
 
class _MultyprojectState extends State<Multyproject> {
 //final String url = "http://192.168.1.100:3000/users/project/viewProject";
  final String url = "http://192.168.1.8:3000/users/dev_home/multiDesign";
  int a=0;
Future<List<Project>> _fetchMultyprojects() async {
