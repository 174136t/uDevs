...
class Naturalpro extends StatefulWidget {
  final Project project;

  Naturalpro(this.project);
  @override
  _NaturalproState createState() => _NaturalproState();
}

class _NaturalproState extends State<Naturalpro> {
