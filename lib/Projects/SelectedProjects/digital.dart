...
class Digitalpro extends StatefulWidget {
  final Project project;

  Digitalpro(this.project);
  @override
  _DigitalproState createState() => _DigitalproState();
}

class _DigitalproState extends State<Digitalpro> {
