...
class Machinepro extends StatefulWidget {
  final Project project;

  Machinepro(this.project);
  @override
  _MachineproState createState() => _MachineproState();
}

class _MachineproState extends State<Machinepro> {
