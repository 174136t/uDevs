...
class Clicom extends StatefulWidget {
  @override
  _ClicomState createState() => _ClicomState();
}

class _ClicomState extends State<Clicom> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  String bid = '';
  bool loading = false;
  final String url1 = "http://192.168.1.8:3000/users/project/viewProReq";
  final String url2 = "http://192.168.1.8:3000/devPro/rec_com_pro";
