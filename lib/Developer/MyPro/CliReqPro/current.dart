...
class Clicur extends StatefulWidget {
  @override
  _ClicurState createState() => _ClicurState();
}

class _ClicurState extends State<Clicur> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  String bid = '';
  bool loading = false;
  final String url1 = "http://192.168.1.8:3000/users/project/viewProReq";
  final String url2 = "http://192.168.1.8:3000/devPro/rec_cur_pro";
