...
class Clicon extends StatefulWidget {
  @override
  _CliconState createState() => _CliconState();
}

class _CliconState extends State<Clicon> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  String bid = '';
  bool loading = false;
  final String url1 = "http://192.168.1.8:3000/users/project/viewProReq";
  final String url2 = "http://192.168.1.8:3000/devPro/rec_con_pro";
