...
class Bidcom extends StatefulWidget {
  @override
  _BidcomState createState() => _BidcomState();
}

class _BidcomState extends State<Bidcom> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  String bid = '';
  bool loading = false;
  final String url1 = "http://192.168.1.8:3000/users/project/viewProReq";
  final String url2 = "http://192.168.1.8:3000/users/devPro/bid_com_pro";
                              ...
                              child: Center(
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Text("No bid completed projects!"),
                                  ],
                                ),
                              ),
                            );
