...
class Bidcur extends StatefulWidget {
  @override
  _BidcurState createState() => _BidcurState();
}

class _BidcurState extends State<Bidcur> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  String bid = '';
  bool loading = false;
  final String url1 = "http://192.168.1.8:3000/users/project/viewProReq";
  final String url2 = "http://192.168.1.8:3000/users/devPro/bid_cur_pro";
