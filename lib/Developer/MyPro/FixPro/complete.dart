...
class Fixcom extends StatefulWidget {
  @override
  _FixcomState createState() => _FixcomState();
}

class _FixcomState extends State<Fixcom> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  String bid = '';
  bool loading = false;
  final String url1 = "http://192.168.1.8:3000/users/project/viewProReq";
  final String url2 = "http://192.168.1.8:3000/users/devPro/fix_com_pro";
                              ...
                              child: Center(
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Text("No fix completed projects!"),
                                  ],
                                ),
                              ),
                            );
