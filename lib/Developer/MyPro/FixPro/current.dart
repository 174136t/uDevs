...
class Fixcur extends StatefulWidget {
  @override
  _FixcurState createState() => _FixcurState();
}

class _FixcurState extends State<Fixcur> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();
  String bid = '';
  bool loading = false;
  final String url1 = "http://192.168.1.8:3000/users/project/viewProReq";
  final String url2 = "http://192.168.1.8:3000/users/devPro/fix_cur_pro";
