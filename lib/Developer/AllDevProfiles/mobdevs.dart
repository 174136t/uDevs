...
class MobDevelopers extends StatefulWidget {
  @override
  _MobDevelopersState createState() => _MobDevelopersState();
}
 
class _MobDevelopersState extends State<MobDevelopers> {
 //final String url = "http://192.168.1.100:3000/users/project/viewProject";
  final String url = "http://192.168.1.8:3000/users/cli_home/mobDeveloper";
  int a=0;
