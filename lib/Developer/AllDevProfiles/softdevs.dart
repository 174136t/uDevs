...
class SoftDevelopers extends StatefulWidget {
  
  @override
  _SoftDevelopersState createState() => _SoftDevelopersState();
}
 
class _SoftDevelopersState extends State<SoftDevelopers> {
 //final String url = "http://192.168.1.100:3000/users/project/viewProject";
  final String url = "http://192.168.1.8:3000/users/cli_home/softDeveloper";
  int a=0;
