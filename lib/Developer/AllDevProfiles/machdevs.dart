...
class MachDevelopers extends StatefulWidget {
  @override
  _MachDevelopersState createState() => _MachDevelopersState();
}
 
class _MachDevelopersState extends State<MachDevelopers> {
 //final String url = "http://192.168.1.100:3000/users/project/viewProject";
  final String url = "http://192.168.1.8:3000/users/cli_home/machineDeveloper";
  int a=0;
