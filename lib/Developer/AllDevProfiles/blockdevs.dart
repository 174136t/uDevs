...
class BlockDevelopers extends StatefulWidget {
  @override
  _BlockDevelopersState createState() => _BlockDevelopersState();
}
 
class _BlockDevelopersState extends State<BlockDevelopers> {
 //final String url = "http://192.168.1.100:3000/users/project/viewProject";
  final String url = "http://192.168.1.8:3000/users/cli_home/blockDeveloper";
  int a=0;
