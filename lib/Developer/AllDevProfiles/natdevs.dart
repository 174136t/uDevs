...
class NatDevelopers extends StatefulWidget {
  @override
  _NatDevelopersState createState() => _NatDevelopersState();
}
 
class _NatDevelopersState extends State<NatDevelopers> {
 //final String url = "http://192.168.1.100:3000/users/project/viewProject";
  final String url = "http://192.168.1.8:3000/users/cli_home/langDeveloper";
  int a=0;
